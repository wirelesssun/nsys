...
BEGIN {
    ...
    require '/home/ubuntu/nsys/Practise_05_OPENSSL/AES_Validator/build/openssl_build/src/ext_openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/ubuntu/nsys/Practise_05_OPENSSL/AES_Validator/build/openssl_build/src/ext_openssl/test/fips-and-base.cnf';
    shift;
