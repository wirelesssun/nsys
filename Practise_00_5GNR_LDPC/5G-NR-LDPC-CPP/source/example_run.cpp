...
void example_run_LDPC()
{
	...
	// Running parameters
	vector<double> EsN0_dB = lin_space(-4, -3, 9);
	// linspace(-4, -3, 9) generates 9 points between -4 and -3, inclusive. So the points are: -4, -3.875, -3.75, -3.625, -3.5, -3.375, -3.25, -3.125, -3.
